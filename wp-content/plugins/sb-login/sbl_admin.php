...
register_setting( 'sbl-settings-group', 'sbl_option_xtra_c' );
register_setting( 'sbl-settings-group', 'sbl_option_xtra' );
register_setting( 'sbl-settings-group', 'sbl_option_xtra_link' );
register_setting( 'sbl-settings-group', 'sbl_option_info' );
register_setting( 'sbl-settings-group', 'email_email' );
register_setting( 'sbl-settings-group', 'email_name' );
register_setting( 'sbl-settings-group', 'email_email_c' );
register_setting( 'sbl-settings-group', 'email_name_c' );
register_setting( 'sbl-settings-group', 'sbl_cap_log' );
register_setting( 'sbl-settings-group', 'sbl_cap_reg' );
}
