=== Plugin Name ===
Contributors: Iroshan, Sumith Harshan, UCSC 
Donate link: http://webexplorar.com/wordpress-sinhala-comments-plugin/
Tags: comments, sinhala, unicode, singlish, Iroshan, Sumith Harshan 
...
== Screenshots ==
1. Simply click on the "සිංහලෙන් comments" button of the comment box.
2. Type your comment in singlish in the "Singlish Box".
3. After submit the comment you can see the comment in sinhala.
...
= 2.5
* Bugfixes:
	*Core functions updated upto compatible with wordpress 4.0.1 version. 
